...
XmppBot::XmppBot()
{
    ...
    this->m_CommandMgr->registerCommand("afk", new AliasBotCommand("afk ","","[<message>] - Go afk. An optional message cam be set",true,statecmd));
    this->m_CommandMgr->registerCommand("re", new AliasBotCommand("re ","","Come back from being afk",true,statecmd));
